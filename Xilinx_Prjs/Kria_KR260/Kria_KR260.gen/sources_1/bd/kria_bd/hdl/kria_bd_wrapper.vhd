...
entity kria_bd_wrapper is
  port (
    ...
    pmod1_io_tri_io : inout STD_LOGIC_VECTOR ( 7 downto 0 );
...
architecture STRUCTURE of kria_bd_wrapper is
  ...
  signal pmod1_io_tri_i_0 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal pmod1_io_tri_i_1 : STD_LOGIC_VECTOR ( 1 to 1 );
  signal pmod1_io_tri_i_2 : STD_LOGIC_VECTOR ( 2 to 2 );
  signal pmod1_io_tri_i_3 : STD_LOGIC_VECTOR ( 3 to 3 );
  signal pmod1_io_tri_i_4 : STD_LOGIC_VECTOR ( 4 to 4 );
  signal pmod1_io_tri_i_5 : STD_LOGIC_VECTOR ( 5 to 5 );
  signal pmod1_io_tri_i_6 : STD_LOGIC_VECTOR ( 6 to 6 );
  signal pmod1_io_tri_i_7 : STD_LOGIC_VECTOR ( 7 to 7 );
  signal pmod1_io_tri_io_0 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal pmod1_io_tri_io_1 : STD_LOGIC_VECTOR ( 1 to 1 );
  signal pmod1_io_tri_io_2 : STD_LOGIC_VECTOR ( 2 to 2 );
  signal pmod1_io_tri_io_3 : STD_LOGIC_VECTOR ( 3 to 3 );
  signal pmod1_io_tri_io_4 : STD_LOGIC_VECTOR ( 4 to 4 );
  signal pmod1_io_tri_io_5 : STD_LOGIC_VECTOR ( 5 to 5 );
  signal pmod1_io_tri_io_6 : STD_LOGIC_VECTOR ( 6 to 6 );
  signal pmod1_io_tri_io_7 : STD_LOGIC_VECTOR ( 7 to 7 );
  signal pmod1_io_tri_o_0 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal pmod1_io_tri_o_1 : STD_LOGIC_VECTOR ( 1 to 1 );
  signal pmod1_io_tri_o_2 : STD_LOGIC_VECTOR ( 2 to 2 );
  signal pmod1_io_tri_o_3 : STD_LOGIC_VECTOR ( 3 to 3 );
  signal pmod1_io_tri_o_4 : STD_LOGIC_VECTOR ( 4 to 4 );
  signal pmod1_io_tri_o_5 : STD_LOGIC_VECTOR ( 5 to 5 );
  signal pmod1_io_tri_o_6 : STD_LOGIC_VECTOR ( 6 to 6 );
  signal pmod1_io_tri_o_7 : STD_LOGIC_VECTOR ( 7 to 7 );
  signal pmod1_io_tri_t_0 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal pmod1_io_tri_t_1 : STD_LOGIC_VECTOR ( 1 to 1 );
  signal pmod1_io_tri_t_2 : STD_LOGIC_VECTOR ( 2 to 2 );
  signal pmod1_io_tri_t_3 : STD_LOGIC_VECTOR ( 3 to 3 );
  signal pmod1_io_tri_t_4 : STD_LOGIC_VECTOR ( 4 to 4 );
  signal pmod1_io_tri_t_5 : STD_LOGIC_VECTOR ( 5 to 5 );
  signal pmod1_io_tri_t_6 : STD_LOGIC_VECTOR ( 6 to 6 );
  signal pmod1_io_tri_t_7 : STD_LOGIC_VECTOR ( 7 to 7 );
...
kria_bd_i: component kria_bd
     port map (
      ...
      pmod1_io_tri_i(7) => pmod1_io_tri_i_7(7),
      pmod1_io_tri_i(6) => pmod1_io_tri_i_6(6),
      pmod1_io_tri_i(5) => pmod1_io_tri_i_5(5),
      pmod1_io_tri_i(4) => pmod1_io_tri_i_4(4),
      pmod1_io_tri_i(3) => pmod1_io_tri_i_3(3),
      pmod1_io_tri_i(2) => pmod1_io_tri_i_2(2),
      pmod1_io_tri_i(1) => pmod1_io_tri_i_1(1),
      pmod1_io_tri_i(0) => pmod1_io_tri_i_0(0),
      pmod1_io_tri_o(7) => pmod1_io_tri_o_7(7),
      pmod1_io_tri_o(6) => pmod1_io_tri_o_6(6),
      pmod1_io_tri_o(5) => pmod1_io_tri_o_5(5),
      pmod1_io_tri_o(4) => pmod1_io_tri_o_4(4),
      pmod1_io_tri_o(3) => pmod1_io_tri_o_3(3),
      pmod1_io_tri_o(2) => pmod1_io_tri_o_2(2),
      pmod1_io_tri_o(1) => pmod1_io_tri_o_1(1),
      pmod1_io_tri_o(0) => pmod1_io_tri_o_0(0),
      pmod1_io_tri_t(7) => pmod1_io_tri_t_7(7),
      pmod1_io_tri_t(6) => pmod1_io_tri_t_6(6),
      pmod1_io_tri_t(5) => pmod1_io_tri_t_5(5),
      pmod1_io_tri_t(4) => pmod1_io_tri_t_4(4),
      pmod1_io_tri_t(3) => pmod1_io_tri_t_3(3),
      pmod1_io_tri_t(2) => pmod1_io_tri_t_2(2),
      pmod1_io_tri_t(1) => pmod1_io_tri_t_1(1),
      pmod1_io_tri_t(0) => pmod1_io_tri_t_0(0),
...
pmod1_io_tri_iobuf_0: component IOBUF
     port map (
      I => pmod1_io_tri_o_0(0),
      IO => pmod1_io_tri_io(0),
      O => pmod1_io_tri_i_0(0),
      T => pmod1_io_tri_t_0(0)
    );
pmod1_io_tri_iobuf_1: component IOBUF
     port map (
      I => pmod1_io_tri_o_1(1),
      IO => pmod1_io_tri_io(1),
      O => pmod1_io_tri_i_1(1),
      T => pmod1_io_tri_t_1(1)
    );
pmod1_io_tri_iobuf_2: component IOBUF
     port map (
      I => pmod1_io_tri_o_2(2),
      IO => pmod1_io_tri_io(2),
      O => pmod1_io_tri_i_2(2),
      T => pmod1_io_tri_t_2(2)
    );
pmod1_io_tri_iobuf_3: component IOBUF
     port map (
      I => pmod1_io_tri_o_3(3),
      IO => pmod1_io_tri_io(3),
      O => pmod1_io_tri_i_3(3),
      T => pmod1_io_tri_t_3(3)
    );
pmod1_io_tri_iobuf_4: component IOBUF
     port map (
      I => pmod1_io_tri_o_4(4),
      IO => pmod1_io_tri_io(4),
      O => pmod1_io_tri_i_4(4),
      T => pmod1_io_tri_t_4(4)
    );
pmod1_io_tri_iobuf_5: component IOBUF
     port map (
      I => pmod1_io_tri_o_5(5),
      IO => pmod1_io_tri_io(5),
      O => pmod1_io_tri_i_5(5),
      T => pmod1_io_tri_t_5(5)
    );
pmod1_io_tri_iobuf_6: component IOBUF
     port map (
      I => pmod1_io_tri_o_6(6),
      IO => pmod1_io_tri_io(6),
      O => pmod1_io_tri_i_6(6),
      T => pmod1_io_tri_t_6(6)
    );
pmod1_io_tri_iobuf_7: component IOBUF
     port map (
      I => pmod1_io_tri_o_7(7),
      IO => pmod1_io_tri_io(7),
      O => pmod1_io_tri_i_7(7),
      T => pmod1_io_tri_t_7(7)
    );
