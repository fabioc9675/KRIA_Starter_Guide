...
\
  ...
  connect_bd_net -net leds_0_addr [get_bd_pins ila_0/probe2] [get_bd_pins leds_0/addr] [get_bd_pins xadc_wiz_0/daddr_in]
  ...
  connect_bd_net -net leds_0_led [get_bd_ports led] [get_bd_pins ila_0/probe1] [get_bd_pins leds_0/led]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ila_0/clk] [get_bd_pins leds_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins rgb_0/ap_clk] [get_bd_pins xadc_wiz_0/dclk_in]
  ...
  connect_bd_net -net xadc_wiz_0_do_out [get_bd_pins ila_0/probe0] [get_bd_pins leds_0/x] [get_bd_pins xadc_wiz_0/do_out]
  connect_bd_net -net xadc_wiz_0_eoc_out [get_bd_pins ila_0/probe3] [get_bd_pins xadc_wiz_0/den_in] [get_bd_pins xadc_wiz_0/eoc_out]
