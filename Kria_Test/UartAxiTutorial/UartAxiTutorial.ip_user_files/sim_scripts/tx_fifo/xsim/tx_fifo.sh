...
#
# Generated by Vivado on Fri Mar 29 01:14:44 -0500 2024
...
# Script info
echo -e "tx_fifo.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L fifo_generator_v13_2_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tx_fifo xil_defaultlib.tx_fifo xil_defaultlib.glbl -log elaborate.log
}
