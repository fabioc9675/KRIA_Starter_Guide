...
architecture STRUCTURE of kria_fir is
  component kria_fir_trapz_fab_real_0_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst : in STD_LOGIC;
    ap_start : in STD_LOGIC;
  ...
  end component kria_fir_trapz_fab_real_0_0;
  signal ap_clk_1 : STD_LOGIC;
  signal ap_rst_1 : STD_LOGIC;
  signal ap_start_1 : STD_LOGIC;
  signal trapz_fab_real_0_y : STD_LOGIC_VECTOR ( 31 downto 0 );
...
begin
  ...
  y_0(31 downto 0) <= trapz_fab_real_0_y(31 downto 0);
trapz_fab_real_0: component kria_fir_trapz_fab_real_0_0
     port map (
      ap_clk => ap_clk_1,
      ap_rst => ap_rst_1,
      ap_start => ap_start_1,
      x(31 downto 0) => x_0_1(31 downto 0),
      y(31 downto 0) => trapz_fab_real_0_y(31 downto 0)
    );
end STRUCTURE;
