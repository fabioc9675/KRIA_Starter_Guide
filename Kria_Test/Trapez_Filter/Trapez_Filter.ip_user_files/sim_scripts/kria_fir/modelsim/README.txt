...
#
# Generated by export_simulation on Fri Feb 09 01:23:13 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './kria_fir.sh' script.

./kria_fir.sh -reset_run
...
./kria_fir.sh -noclean_files

For more information on the script, please type './kria_fir.sh -help'.
