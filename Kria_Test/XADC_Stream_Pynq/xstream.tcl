...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:ADC_Stream:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ADC_Stream_0, and set properties
  set ADC_Stream_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ADC_Stream:1.0 ADC_Stream_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net ADC_Stream_0_M00_AXIS [get_bd_intf_pins ADC_Stream_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ADC_Stream_0/m00_axis_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ADC_Stream_0/m00_axis_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xadc_wiz_0_do_out [get_bd_pins ADC_Stream_0/data_in] [get_bd_pins xadc_wiz_0/do_out]
  connect_bd_net -net xadc_wiz_0_drdy_out [get_bd_pins ADC_Stream_0/clk_adc] [get_bd_pins xadc_wiz_0/drdy_out]
