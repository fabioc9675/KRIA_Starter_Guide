...
\
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins clock_div_0/clk_in] [get_bd_pins leds_0/ap_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rgb_0/ap_clk]
  connect_bd_net -net clock_div_0_clk_out [get_bd_pins clock_div_0/clk_out] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins fir_fab_0/ap_clk] [get_bd_pins trapz_klm_0/ap_clk]
  connect_bd_net -net comblock_0_reg0_o [get_bd_pins comblock_0/fifo_we_i] [get_bd_pins comblock_0/reg0_o]
  connect_bd_net -net comblock_0_reg1_o [get_bd_pins comblock_0/fifo_clear_i] [get_bd_pins comblock_0/reg1_o]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins fir_fab_0/ap_rst] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins trapz_klm_0/ap_rst]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_smc/aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net xadc_wiz_0_do_out [get_bd_pins comblock_0/fifo_data_i] [get_bd_pins fir_fab_0/x] [get_bd_pins leds_0/x] [get_bd_pins trapz_klm_0/x] [get_bd_pins xadc_wiz_0/do_out]
