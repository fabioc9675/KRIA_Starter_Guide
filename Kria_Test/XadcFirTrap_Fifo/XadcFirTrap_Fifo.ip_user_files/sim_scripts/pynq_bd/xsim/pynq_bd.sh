...
simulate()
{
  xsim  pynq_bd -key {Behavioral:sim_1:Functional:pynq_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48aa.protoinst" -protoinst "protoinst_files/pynq_bd.protoinst" -log simulate.log
}
