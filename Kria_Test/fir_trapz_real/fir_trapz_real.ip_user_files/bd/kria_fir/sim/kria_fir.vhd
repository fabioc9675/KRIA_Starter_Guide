...
architecture STRUCTURE of kria_fir is
  component kria_fir_fir_fab_0_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst : in STD_LOGIC;
    ap_start : in STD_LOGIC;
  ...
  end component kria_fir_fir_fab_0_0;
  component kria_fir_trapz_klm_0_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst : in STD_LOGIC;
    ap_start : in STD_LOGIC;
  ...
  end component kria_fir_trapz_klm_0_0;
...
fir_fab_0: component kria_fir_fir_fab_0_0
     port map (
      ap_clk => ap_clk_1,
      ap_rst => ap_rst_1,
      ap_start => ap_start_1,
...
trapz_klm_0: component kria_fir_trapz_klm_0_0
     port map (
      ap_clk => ap_clk_1,
      ap_rst => ap_rst_1,
      ap_start => ap_start_1,
