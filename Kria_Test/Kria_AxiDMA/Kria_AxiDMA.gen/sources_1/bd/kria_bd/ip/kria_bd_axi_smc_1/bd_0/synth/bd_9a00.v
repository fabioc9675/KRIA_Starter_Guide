...
(* CORE_GENERATION_INFO = "bd_9a00,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_9a00,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=44,numReposBlks=34,numNonXlnxBlks=0,numHierBlks=10,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "kria_bd_axi_smc_1.hwdef" *) 
module bd_9a00
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
