...
architecture behav of fir is 
    ...
    "fir_fir,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.128000,HLS_SYN_LAT=103,HLS_SYN_TPT=104,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=3540,HLS_SYN_LUT=1347,HLS_VERSION=2022_2}";
