...
#
# pruebaTCL.tcl: Tcl script for re-creating project 'pruebaTCL'
#
# Generated by Vivado on Mon Dec 25 13:04:13 -0500 2023
...
#
# 1. This project restoration tcl script (pruebaTCL.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/Users/Kria_CustomIP/pruebaTCL/pruebaTCL.srcs/utils_1/imports/synth_1/Led_Full.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "D:/Users/Kria_CustomIP/Fab_LedCounter/Fab_LedCounter.srcs/sources_1/new/Led_4count.vhd"
#    "D:/Users/Kria_CustomIP/Fab_LedCounter/Fab_LedCounter.srcs/sources_1/new/Led_Bouncing.vhd"
#    "D:/Users/Kria_CustomIP/Fab_LedCounter/Fab_LedCounter.srcs/sources_1/new/Led_Logic.vhd"
#    "D:/Users/Kria_CustomIP/Fab_LedCounter/Fab_LedCounter.srcs/sources_1/new/Led_Full.vhd"
#    "D:/Users/Kria_CustomIP/Fab_LedCounter/Fab_LedCounter.srcs/constrs_1/new/constrains.xdc"
#    "D:/Users/Kria_CustomIP/Fab_LedCounter/Fab_LedCounter.srcs/constrs_1/new/fan_pinout.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../pruebaTCL/pruebaTCL.srcs/utils_1/imports/synth_1/Led_Full.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/Fab_LedCounter.srcs/sources_1/new/Led_4count.vhd"]"\
 "[file normalize "$origin_dir/Fab_LedCounter.srcs/sources_1/new/Led_Bouncing.vhd"]"\
 "[file normalize "$origin_dir/Fab_LedCounter.srcs/sources_1/new/Led_Logic.vhd"]"\
 "[file normalize "$origin_dir/Fab_LedCounter.srcs/sources_1/new/Led_Full.vhd"]"\
 "[file normalize "$origin_dir/Fab_LedCounter.srcs/constrs_1/new/constrains.xdc"]"\
 "[file normalize "$origin_dir/Fab_LedCounter.srcs/constrs_1/new/fan_pinout.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set orig_proj_dir "[file normalize "$origin_dir/../pruebaTCL"]"
...
set file "$origin_dir/Fab_LedCounter.srcs/sources_1/new/Led_4count.vhd"
...
set file "$origin_dir/Fab_LedCounter.srcs/sources_1/new/Led_Bouncing.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/Fab_LedCounter.srcs/sources_1/new/Led_Logic.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/Fab_LedCounter.srcs/sources_1/new/Led_Full.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "design_leds_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/Fab_LedCounter.srcs/constrs_1/new/constrains.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/Fab_LedCounter.srcs/constrs_1/new/constrains.xdc"
set file [file normalize $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/Fab_LedCounter.srcs/constrs_1/new/fan_pinout.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/Fab_LedCounter.srcs/constrs_1/new/fan_pinout.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "Led_Full" -objects $obj
set_property -name "top_arch" -value "Behavioral" -objects $obj
set_property -name "top_file" -value "Fab_LedCounter.srcs/sources_1/new/Led_Full.vhd" -objects $obj
...
if { [get_files Led_4count.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/Users/Kria_CustomIP/Fab_LedCounter/Fab_LedCounter.srcs/sources_1/new/Led_4count.vhd
}
if { [get_files Led_Bouncing.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/Users/Kria_CustomIP/Fab_LedCounter/Fab_LedCounter.srcs/sources_1/new/Led_Bouncing.vhd
}
if { [get_files Led_Logic.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/Users/Kria_CustomIP/Fab_LedCounter/Fab_LedCounter.srcs/sources_1/new/Led_Logic.vhd
}
if { [get_files Led_Full.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/Users/Kria_CustomIP/Fab_LedCounter/Fab_LedCounter.srcs/sources_1/new/Led_Full.vhd
}


# Proc to create BD design_leds
proc cr_bd_design_leds { parentCell } {
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.793452",
   "Default View_TopLeft":"-125,0",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace portBus LED_OUT -pg 1 -lvl 4 -x 1420 -y 700 -defaultsOSRD
preplace portBus PUL_IN -pg 1 -lvl 0 -x 0 -y 710 -defaultsOSRD
preplace portBus fan_en_b -pg 1 -lvl 4 -x 1420 -y 60 -defaultsOSRD
preplace inst Led_Full_0 -pg 1 -lvl 3 -x 1230 -y 700 -defaultsOSRD
preplace inst axi_intc_0 -pg 1 -lvl 3 -x 1230 -y 210 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 2 -x 900 -y 450 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -x 370 -y 470 -defaultsOSRD
preplace inst proc_sys_reset_1 -pg 1 -lvl 3 -x 1230 -y 550 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 900 -y 180 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 3 -x 1230 -y 60 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 370 -y 200 -defaultsOSRD
preplace netloc Led_Full_0_LED 1 3 1 NJ 700
preplace netloc PUL_0_1 1 0 3 NJ 710 NJ 710 NJ
preplace netloc axi_intc_0_irq 1 0 4 20 340 NJ 340 NJ 340 1400
preplace netloc clk_wiz_0_clk_out1 1 0 3 20 580 NJ 580 1050
preplace netloc clk_wiz_0_clk_out2 1 0 3 20 60 730 300 1060
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 1 750 160n
preplace netloc xlslice_0_Dout 1 3 1 NJ 60
preplace netloc zynq_ultra_ps_e_0_emio_ttc0_wave_o 1 1 2 740J 60 NJ
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 1 1 710 260n
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 3 30 570 720 530 NJ
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 N 180
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 1 1 N 120
levelinfo -pg 1 0 370 900 1230 1420
pagesize -pg 1 -db -bbox -sgen -130 0 1570 770
"
}
...
# End of cr_bd_design_leds()
cr_bd_design_leds ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files design_leds.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files design_leds.bd ] 
set_property IS_ENABLED "1" [get_files design_leds.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files design_leds.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files design_leds.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files design_leds.bd ] 
set_property PFM_NAME "" [get_files design_leds.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files design_leds.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files design_leds.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files design_leds.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files design_leds.bd ] 
set_property USED_IN_SIMULATION "1" [get_files design_leds.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files design_leds.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse design_leds.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../pruebaTCL/pruebaTCL.gen/sources_1/bd/design_leds/hdl/design_leds_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse design_leds.bd] -top]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/pruebaTCL.srcs/utils_1/imports/synth_1/Led_Full.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/pruebaTCL.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/pruebaTCL.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/pruebaTCL.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
