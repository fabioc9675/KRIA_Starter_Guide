...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:Fab_Led_IP:1.3\
...
proc create_root_design { parentCell } {
  ...
  set Fab_Led_IP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Fab_Led_IP:1.3 Fab_Led_IP_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Fab_Led_IP_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Fab_Led_IP_0_out_ext [get_bd_ports leds_4bits_tri_o] [get_bd_pins Fab_Led_IP_0/out_ext]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports sysclk] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins Fab_Led_IP_0/clk_ext] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Fab_Led_IP_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Fab_Led_IP_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Fab_Led_IP_0/S00_AXI/S00_AXI_reg] -force
