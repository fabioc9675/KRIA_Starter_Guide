...
using hls::sim::Byte;
extern "C" void GN_inference(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
extern "C" void apatb_GN_inference_hw(volatile void * __xlx_apatb_param_input_V_data_V, volatile void * __xlx_apatb_param_input_V_keep_V, volatile void * __xlx_apatb_param_input_V_strb_V, volatile void * __xlx_apatb_param_input_V_user_V, volatile void * __xlx_apatb_param_input_V_last_V, volatile void * __xlx_apatb_param_input_V_id_V, volatile void * __xlx_apatb_param_input_V_dest_V, volatile void * __xlx_apatb_param_result) {
...
auto* sinput_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_input_V_dest_V);
  // DUT call
  GN_inference(sinput_V_data_V->data<int>(), sinput_V_keep_V->data<char>(), sinput_V_strb_V->data<char>(), sinput_V_user_V->data<char>(), sinput_V_last_V->data<char>(), sinput_V_id_V->data<char>(), sinput_V_dest_V->data<char>(), __xlx_apatb_param_result);
