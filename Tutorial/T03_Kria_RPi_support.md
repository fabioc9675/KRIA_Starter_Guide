...
El mapeo de los pines entre la KR260 y la Kria es un poco confusa, pero aqui hay una guia rapida de como se debe mapear el pinout teniendo en cuenta las conexiones del modulo KR260 y la SOM Kria.

en primer lugar tendremos en cuenta el [esquematico](https://www.xilinx.com/member/forms/download/design-license.html?cid=bad0ada6-9a32-427e-a793-c68fed567427&filename=xtp743-kr260-schematic.zip) de la tarjeta KR260, en este aparecen las conexiones con los diferentes perifericos de la carrier board.

En especifico nos centraremos en las coexiones de los puertos Mezanine

![Petalinux_download](./T04_Images/KR260_Meza_01.png)
![Petalinux_download](./T04_Images/KR260_Meza_02.png)

Ahora miraremos algunos perifericos como las conexiones a los PMODs, el RPi y los User LEDs.
...
Finalmente utilizaremos el siguiente archivo .xdc para mapear los pines del PL.
...
Luego así, podemos mapear los pines de los LEDs de usuario como sigue
...
Mapeo entre periferico y Mezanine connector

![Petalinux_download](./T04_Images/pinmap.png)

Mapeo entre mezanine y Kria
